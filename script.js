...
const arr = [{
  ...
  intro1: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
  techstack1: ['html', 'css', 'javaScript'],
  heading2: 'Facebook 360',
  list2: ['Facebook', 'Full Stack Dev', '2015'],
  intro2: 'Exploring the future of media in Facebook\'s first Virtual Reality app; a place to discover and enjoy 360 photos and videos on Gear VR.',
...
},
  {
    ...
    intro2: 'A smart assistant to make driving more safe, efficient, and fun by unlocking your most expensive computer: your car.',
    techstack2: ['html', 'Ruby on Rails', 'css', 'javaScript'],
    list3: ['html', 'css', 'javaScript', 'github', 'ruby', 'Bootstrap'],
    mainbtn: ['See Project'],
    popupbtn: ['See Live', 'See Source'],
  ...
  },
  {
    ...
    intro2: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    techstack2: ['html', 'Ruby on Rails', 'css', 'javaScript'],
    list3: ['html', 'css', 'javaScript', 'github', 'ruby', 'Bootstrap'],
    mainbtn: ['See Project'],
    popupbtn: ['See Live', 'See Source'],
  ...
  },
  {
    ...
    list2: ['Facebook', 'Full Stack Dev', '2015'],
    intro2: 'Experimental content creation feature that allows users to add to an existing story over the course of a day without spamming their friends.',
    techstack2: ['html', 'Ruby on Rails', 'css', 'javaScript'],
    list3: ['html', 'css', 'javaScript', 'github', 'ruby', 'Bootstrap'],
    mainbtn: ['See Project'],
    popupbtn: ['See Live', 'See Source'],
  ...
  for (let i = 0; i < arr.length; i += 1) {
	...
	>
		...
		<div class="about-portfolio">
			...
			<button class="btn project-btn-small common-btn" data-size="${arr[i].btn[0]}" type="button">
				See Projects
			</button>
		</div>
		...
		<div class="about-portfolio-max">
			...
			<button class="btn project-btn-large common-btn" data-size="${arr[i].btn[0]}" type="button">
				See Projects
			</button>
		</div>
	</div>
