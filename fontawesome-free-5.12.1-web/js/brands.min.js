 ...
 */
!(function () {
  let c = {}; let z = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (z = document); } catch (c) {} const l = (c.navigator || {}).userAgent; const h = void 0 === l ? '' : l; const v = c; const m = z; const a = (v.document, !!m.documentElement && !!m.head && typeof m.addEventListener === 'function' && m.createElement, ~h.indexOf('MSIE') || h.indexOf('Trident/'), '___FONT_AWESOME___'); const M = (function () { try { return !0; } catch (c) { return !1; } }()); const s = v || {}; s[a] || (s[a] = {}), s[a].styles || (s[a].styles = {}), s[a].hooks || (s[a].hooks = {}), s[a].shims || (s[a].shims = []); const H = s[a]; function f(c, h) {
    const z = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks; const l = void 0 !== z && z; const v = Object.keys(h).reduce((c, z) => { const l = h[z]; return l.icon ? c[l.iconName] = l.icon : c[z] = l, c; }, {}); typeof H.hooks.addPack !== 'function' || l ? H.styles[c] = (function (v) {
      for (let c = 1; c < arguments.length; c++) {
        var m = arguments[c] != null ? arguments[c] : {}; let z = Object.keys(m); typeof Object.getOwnPropertySymbols === 'function' && (z = z.concat(Object.getOwnPropertySymbols(m).filter((c) => Object.getOwnPropertyDescriptor(m, c).enumerable))), z.forEach((c) => {
          let z; let l; let h; z = v, h = m[l = c], l in z ? Object.defineProperty(z, l, {
            value: h, enumerable: !0, configurable: !0, writable: !0,
          }) : z[l] = h;
        });
      } return v;
    }({}, H.styles[c] || {}, v)) : H.hooks.addPack(c, v), c === 'fas' && f('fa', h);
  } const e = {
  ...
  }; !(function (c) { try { c(); } catch (c) { if (!M) throw c; } }(() => { f('fab', e); }));
}());