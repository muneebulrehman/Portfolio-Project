 ...
 */
!(function () {
  let c = {}; let h = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (h = document); } catch (c) {} const l = (c.navigator || {}).userAgent; const v = void 0 === l ? '' : l; const z = c; const a = h; const m = (z.document, !!a.documentElement && !!a.head && typeof a.addEventListener === 'function' && a.createElement, ~v.indexOf('MSIE') || v.indexOf('Trident/'), '___FONT_AWESOME___'); const M = (function () { try { return !0; } catch (c) { return !1; } }()); const s = z || {}; s[m] || (s[m] = {}), s[m].styles || (s[m].styles = {}), s[m].hooks || (s[m].hooks = {}), s[m].shims || (s[m].shims = []); const H = s[m]; function V(c, v) {
    const h = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks; const l = void 0 !== h && h; const z = Object.keys(v).reduce((c, h) => { const l = v[h]; return l.icon ? c[l.iconName] = l.icon : c[h] = l, c; }, {}); typeof H.hooks.addPack !== 'function' || l ? H.styles[c] = (function (z) {
    ...
    }({}, H.styles[c] || {}, z)) : H.hooks.addPack(c, z), c === 'fas' && V('fa', v);
  } const f = {
  ...
  }; !(function (c) { try { c(); } catch (c) { if (!M) throw c; } }(() => { V('fas', f); }));
}());