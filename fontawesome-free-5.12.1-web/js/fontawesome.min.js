...
!(function () {
  function i(t) { return (i = typeof Symbol === 'function' && typeof Symbol.iterator === 'symbol' ? function (t) { return typeof t; } : function (t) { return t && typeof Symbol === 'function' && t.constructor === Symbol && t !== Symbol.prototype ? 'symbol' : typeof t; })(t); } function r(t, e) { for (let n = 0; n < e.length; n++) { const a = e[n]; a.enumerable = a.enumerable || !1, a.configurable = !0, 'value' in a && (a.writable = !0), Object.defineProperty(t, a.key, a); } } function K(r) {
    ...
    }; u && (v.attributes[G] = ''), s && v.children.push({ tag: 'title', attributes: { id: v.attributes['aria-labelledby'] || 'title-'.concat(kt()) }, children: [s] }); let b; let y; let w; let x; let k; let A; let C; let O; let S; let P; let N; let M; let z; let E; let j; let L; let R; let _; let T; let I; let Y; let F; let H; let D; let U; let W; const q = K({}, v, {
      prefix: r, iconName: i, main: n, mask: a, transform: o, symbol: c, styles: l.styles,
    }); const X = a.found && n.found ? (w = (b = q).children, x = b.attributes, k = b.main, A = b.mask, C = b.transform, O = k.width, S = k.icon, P = A.width, N = A.icon, M = Mt({ transform: C, containerWidth: P, iconWidth: O }), z = { tag: 'rect', attributes: K({}, zt, { fill: 'white' }) }, E = S.children ? { children: S.children.map(Et) } : {}, j = { tag: 'g', attributes: K({}, M.inner), children: [Et(K({ tag: S.tag, attributes: K({}, S.attributes, M.path) }, E))] }, L = { tag: 'g', attributes: K({}, M.outer), children: [j] }, R = 'mask-'.concat(kt()), _ = 'clip-'.concat(kt()), T = { tag: 'mask', attributes: K({}, zt, { id: R, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }), children: [z, L] }, I = { tag: 'defs', children: [{ tag: 'clipPath', attributes: { id: _ }, children: (y = N, y.tag === 'g' ? y.children : [y]) }, T] }, w.push(I, { tag: 'rect', attributes: K({ fill: 'currentColor', 'clip-path': 'url(#'.concat(_, ')'), mask: 'url(#'.concat(R, ')') }, zt) }), { children: w, attributes: x }) : (function (t) { const e = t.children; const n = t.attributes; const a = t.main; const r = t.transform; const i = Pt(t.styles); if (i.length > 0 && (n.style = i), Nt(r)) { const o = Mt({ transform: r, containerWidth: a.width, iconWidth: a.width }); e.push({ tag: 'g', attributes: K({}, o.outer), children: [{ tag: 'g', attributes: K({}, o.inner), children: [{ tag: a.icon.tag, children: a.icon.children, attributes: K({}, a.icon.attributes, o.path) }] }] }); } else e.push(a.icon); return { children: e, attributes: n }; }(q)); const B = X.children; const V = X.attributes; return q.children = B, q.attributes = V, c ? (F = (Y = q).prefix, H = Y.iconName, D = Y.children, U = Y.attributes, W = Y.symbol, [{ tag: 'svg', attributes: { style: 'display: none;' }, children: [{ tag: 'symbol', attributes: K({}, U, { id: !0 === W ? ''.concat(F, '-').concat(J.familyPrefix, '-').concat(H) : W }), children: D }] }]) : (function (t) { const e = t.children; const n = t.main; const a = t.mask; const r = t.attributes; const i = t.styles; const o = t.transform; if (Nt(o) && n.found && !a.found) { const c = n.width / n.height / 2; const s = 0.5; r.style = Pt(K({}, i, { 'transform-origin': ''.concat(c + o.x / 16, 'em ').concat(s + o.y / 16, 'em') })); } return [{ tag: 'svg', attributes: r, children: e }]; }(q));
  } function Lt(t) {
    const e = t.content; const n = t.width; const a = t.height; const r = t.transform; const i = t.title; const o = t.extra; const c = t.watchable; const s = void 0 !== c && c; const l = K({}, o.attributes, i ? { title: i } : {}, { class: o.classes.join(' ') }); s && (l[G] = ''); let f; let u; let d; let m; let p; let h; let g; let v; let b; const y = K({}, o.styles); Nt(r) && (y.transform = (u = (f = {
    ...
    return new vt((t, e) => {
      ...
      }; if (a && r && ve[r] && ve[r][a]) return t(be(ve[r][a])); i(g.FontAwesomeKitConfig) === 'object' && typeof window.FontAwesomeKitConfig.token === 'string' && g.FontAwesomeKitConfig.token, a && r && !J.showMissingIcons ? e(new ue('Icon is missing for prefix '.concat(r, ' with icon name ').concat(a))) : t(n);
    });
    ...
    const e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}; const n = e.transform; const a = void 0 === n ? yt : n; const r = e.symbol; const i = void 0 !== r && r; const o = e.mask; const c = void 0 === o ? null : o; const s = e.title; const l = void 0 === s ? null : s; const f = e.classes; const u = void 0 === f ? [] : f; const d = e.attributes; const m = void 0 === d ? {} : d; const p = e.styles; const h = void 0 === p ? {} : p; if (t) {
      const g = t.prefix; const v = t.iconName; const b = t.icon; return Ee(K({ type: 'icon' }, t), () => (ze(), J.autoA11y && (l ? m['aria-labelledby'] = ''.concat(J.replacementClass, '-title-').concat(kt()) : (m['aria-hidden'] = 'true', m.focusable = 'false')), jt({
        icons: {
          main: be(b),
          mask: c ? be(c.icon) : {
  ...
  }, function (t) { const e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}; const n = (t || {}).icon ? t : je(t || {}); let a = e.mask; return a && (a = (a || {}).icon ? a : je(a || {})), Le(n, K({}, e, { mask: a })); }); const Ye = {
    ...
    toHtml: Zt,
  }; var Fe = function () { const t = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot; const e = void 0 === t ? v : t; (Object.keys(W.styles).length > 0 || J.autoFetchSvg) && p && J.autoReplaceSvg && Ye.dom.i2svg({ node: e }); }; !(function (t) { try { t(); } catch (t) { if (!M) throw t; } }(() => { u && (g.FontAwesome || (g.FontAwesome = Ye), B(() => { Fe(), ce({ treeCallback: ke, nodeCallback: Ae, pseudoElementsCallback: Pe }); })), W.hooks = K({}, W.hooks, { addPack(t, e) { W.styles[t] = K({}, W.styles[t] || {}, e), Bt(), Fe(); }, addShims(t) { let e; (e = W.shims).push.apply(e, m(t)), Bt(), Fe(); } }); }));
}());